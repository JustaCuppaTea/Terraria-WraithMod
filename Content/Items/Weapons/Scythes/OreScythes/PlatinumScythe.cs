...
namespace WraithMod.Content.Items.Weapons.Scythes.OreScythes
{
    ...
    /// </summary>
    public class PlatinumScythe : BaseScythe
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<PlatinumCoin>(); // ID of the projectiles the sword will shoot
    ...
    public class PlatinumCoin : ModProjectile
    {
        public override void SetStaticDefaults()
        {
        ...
        public override void AI()
        {
            ...
            Lighting.AddLight(Projectile.position, 1.36f, 1.64f, 1.76f);
            SoundEngine.PlaySound(SoundID.CoinPickup, Projectile.position);
            if (Main.rand.NextBool(3))
            {
                int num474 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.Platinum, Projectile.velocity.X, Projectile.velocity.Y, 0);

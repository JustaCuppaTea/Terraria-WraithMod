...
namespace WraithMod.Content.Items.Weapons.Scythes.OreScythes
{
    ...
    /// </summary>
    public class TungstenScythe : BaseScythe
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<TungstenCoin>(); // ID of the projectiles the sword will shoot
    ...
    public class TungstenCoin : ModProjectile
    {
        public override void SetStaticDefaults()
        {
        ...
        public override void AI()
        {
            ...
            Lighting.AddLight(Projectile.position, 1.08f, 1.47f, 1.07f);
            SoundEngine.PlaySound(SoundID.CoinPickup, Projectile.position);
            if (Main.rand.NextBool(2))
            {
                int num474 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.Tungsten, Projectile.velocity.X, Projectile.velocity.Y, 0);

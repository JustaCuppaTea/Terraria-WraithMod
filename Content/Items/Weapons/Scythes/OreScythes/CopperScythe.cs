...
namespace WraithMod.Content.Items.Weapons.Scythes.OreScythes
{
    ...
    /// </summary>
    public class CopperScythe : BaseScythe
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<CopperCoin>(); // ID of the projectiles the sword will shoot
    ...
    public class CopperCoin : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Lighting.AddLight(Projectile.position, 1.83f, 0.88f, 0.25f);
            SoundEngine.PlaySound(SoundID.CoinPickup, Projectile.position);
            if (Main.rand.NextBool(2))
            {
                int num474 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.Copper);

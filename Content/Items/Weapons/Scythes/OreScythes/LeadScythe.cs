...
namespace WraithMod.Content.Items.Weapons.Scythes.OreScythes
{
    ...
    /// </summary>
    public class LeadScythe : BaseScythe
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<LeadAnvilProj>();
        ...
        {
            Projectile.NewProjectile(Item.GetSource_FromThis(), Main.MouseWorld, new Vector2(0, 0), ModContent.ProjectileType<LeadAnvilProj>(), damage, knockback, player.whoAmI);
            return false;
        }
    }

    public class LeadAnvilProj : ModProjectile
    {
        int SpawnDust = 0;

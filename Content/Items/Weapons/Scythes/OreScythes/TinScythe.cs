...
namespace WraithMod.Content.Items.Weapons.Scythes.OreScythes
{
    ...
    /// </summary>
    public class TinScythe : BaseScythe
    {
        public override void SetStaticDefaults()
        {
            // Tooltip.SetDefault("Shoots out a couple tin coins that home onto enemies weakly.\nLifecost " + LifeCost);
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<TinCoin>(); // ID of the projectiles the sword will shoot
    ...
    public class TinCoin : ModProjectile
    {
        public override void SetStaticDefaults()
        {
        ...
        public override void AI()
        {
            ...
            Lighting.AddLight(Projectile.position, 0.87f, 0.92f, 0.8f);
            SoundEngine.PlaySound(SoundID.CoinPickup, Projectile.position);
            if (Main.rand.NextBool(2))
            {
                int num474 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.Tin, Projectile.velocity.X, Projectile.velocity.Y, 0);
            ...
            float maxDetectRadius = 175f; // The maximum radius at which a projectile can detect a target
            ...
            Projectile.velocity = (closestNPC.Center - Projectile.Center).SafeNormalize(Vector2.Zero) * projSpeed + Main.rand.NextVector2Circular(7, 7);
        }
    }
}